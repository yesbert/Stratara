...
/// too. A permit is released by its unit, by its lease lapsing without renewal, or by its holder being declared dead.
/// </summary>
internal sealed class PermitLedger
{
    ...
    /// <summary>Takes a permit for a new unit, unless the grace has not ended or the bound is reached; a unit already held keeps its permit.</summary>
