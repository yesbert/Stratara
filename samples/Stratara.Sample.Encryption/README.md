...
**One of two Why-Stratara hero samples.** Shows how `[EncryptData]` fields stay confidential across tenants even when the database leaks — distilled to ~155 lines of in-memory code.
