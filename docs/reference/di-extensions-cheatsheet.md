...
| `services.AddStrataraPortableCounterReader<TWriteContext>()` | The commit-order reader for any relational provider, with the partition counter it maintains and the one-time backfill of existing entries |
