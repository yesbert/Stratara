...
| `117_124` | IntentHandOverDropped | Debug | A resumed command's hand-over found the command already taken by another runner — a second resumption of the same claim — or completed, and was dropped without running the handler |
