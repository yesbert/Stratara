...
2. **[First Stratara App](first-stratara-app.md)** — a 30-line console app that registers a mediator, dispatches a command, and queries the result.
3. **[DI Composition](di-composition.md)** — the menu of `Add*Services()` extensions and when to pick each.

When you're ready for the runnable demos, jump to **[Samples](../samples/index.md)**.
