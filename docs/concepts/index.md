...
- **[Performance and Scaling](performance-and-scaling.md)** — reflection-free hot paths, push-driven projections, deterministic 4096-bucket partitioning for horizontal worker scaling, and the measured numbers behind them (~11 ns/event replay at constant 64-byte allocation; property access ~13× faster than reflection; integrity hashing sub-microsecond; zero-allocation logging when disabled).
